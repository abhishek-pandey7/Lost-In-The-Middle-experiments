...
"""
================================================================================
LITM v4 — Experiment 4: Fact-Dependent Reasoning
...
def parse_args():
    p = argparse.ArgumentParser(description="LITM v4 - Exp 4: Fact-Dependent Reasoning")
...
def main():
    args = parse_args()
    out_dir = os.path.join(args.output, "exp4_reason")
    os.makedirs(out_dir, exist_ok=True)

    logger.info("=" * 60)
    logger.info("LITM v4 - Experiment 4: Fact-Dependent Reasoning")
    logger.info(f"Model: {args.model}")
    logger.info(f"Examples: {args.n_examples} | Sentences: {args.n_sentences}")
    logger.info(f"Output: {out_dir}")
    logger.info("=" * 60)

    result = run_fact_reasoning(
